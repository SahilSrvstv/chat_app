...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    myFocusNode.addListener(() {
      if (myFocusNode.hasFocus) {
        ...
        // then theamount of remaining space will be calculated
        // then scroll down
        Future.delayed(
    ...
    // wait for listview to be built amd then scroll to bottom
    Future.delayed(
      const Duration(milliseconds: 500),
      () => scrollDown(),
    );
  ...
  void sendMessage() async {
    // if thier is something inside the text field
  ...
  Widget _buildMessageItems(DocumentSnapshot doc) {
    ...
    //align message to right if sender else align to left
    var alignment =
  ...
  Widget _buildUserInput() {
    return Padding(
      ...
      child: Row(
        children: [
          // text field utilizing maximum space
          Expanded(
            child: MyTextField(
